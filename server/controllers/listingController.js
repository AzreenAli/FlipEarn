...
export const addListing = async (req, res) =>{
    ...
    // wait for all uploads tocomplete
...
// for updating listing in database
...
export const deleteUserListing = async (req, res) => {
    try {
        ...
        // if pass has been changed, send the new password to owner
...
export const markFeatured = async (req, res) => {
    try {
        ...
        // Mark the listing as feat 
         await prisma.listing.update({
            where: { id },
            data: { featured: true },
        })

        return res.json ({message: "Listing market as featured"})
