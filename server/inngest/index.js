...
export const inngest = new Inngest({ id: "flipearn-dev" });
...
// inngest func to update user data in database
...
// Inngest credential to send new credential for deleted listings
