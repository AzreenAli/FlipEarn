  ...
  return (
    <div className='relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition'>
      ...
      {listing.featured && (
        <>
        <p className='py-1' />
        <div className='absolute top-0 left-0 w-full bg-linear-to-r from-pink-500 text-white text-center text-xs font-semibold py-1 tracking-wide uppercase'>Featured</div>
        </>
      )}
...
<div className='p-5 pt-8'>
    ...
    {/** Stats */}
      ...
      {/** Tags and Loaction */}
        ...
        {/** Description */}
          <p className='text-sm text-gray-600 mb-4 line-clamp-2'>{listing.
          description}</p>
          ...
          <div className='flex items-center justify-between'>
            ...
            <button onClick={() => {navigate(`/listing/${listing.id}`); scrollTo(0,
            0)}}className='px-7 py-3 bg-indigo-600 text-white text-sm rounded-lg 
