      ...
      <div className='bg-white sm:rounded-lg shadow-2xl w-full max-w-2xl h-screen sm:h-150 flex flex-col'>
        ...
        sm:rounded-t-lg flex items-center justify-between'>
            <div className='flex-1 min-w-0'>
                ...
                chatUser?.name || 'Loading...'})` : `Chatting with seller (${chat?.
                    ownerUser?.name || 'Loading...'}) `}</p>
            </div>
                        ...
                        messages.map((message)=>(
                            ...
                            user.id ? "justify-end" : "justify-start"}`}> 
                                ...
                                "bg-white border border-gray-200 text-gray-800"}`}>
                                   ...
                                   user.id ? "text-indigo-200" : "text-green-400" }`}>
        ...
        (
            <form onSubmit={handleSendMessage} className='p-4 bg-white border-t border-gray-200 rounded-b-lg'>
                <div className='flex items-end space-x-2'>
                    ...
                    type='submit' className='bg-indigo-600 hover:bg-indigo-700 text-white p-2.5
