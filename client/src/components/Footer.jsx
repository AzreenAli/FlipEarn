...
const Footer = () => {
  return (
    <>
    <footer className="mt-32 relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    ...
                    <p className="text-sm/7 mt-6">
                        flipearn is a social media marketplace. We are the leading social media marketplace that connects
