...
const FilterSidebar = ({ showFilterPhone, setShowFilterPhone, filters, setFilters }) => {
    ...
    return (
        ...
        max-sm:insert-0 z-100 max-sm:h-screen max-sm:overflow-scroll bg-white rounded-lg 
        shadow-sm border border-gray-200 h-fit sticky top-24 md:min-w-300px`}>
            ...
            <div className='p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar'>
                {/** Search Bar */}
                <div className='flex items-center justify-between'>
                    <input type="text" placeholder='Search by username, platform, niche, 
            etc.'className='w-full text-sm px-3 py-2 border border-gray-300
            ...
            items-center justify-between w-full mb-3'>
                ...
                {/**Price Range */}
                <div>
                    <button onClick={() => toggleSection("price")} className='flex 
            items-center justify-between w-full mb-3'>
                        <label text-sm font-medium text-gray-800>Price Range</label>
                    ...
                    {expandedSections.price && (
                        <div className='space-y-3'>
                            ...
                            {filters.maxPrice || 100000} onChange={(e)=>onFiltersChange({...
            ...
            items-center justify-between w-full mb-3'>
                        <label text-sm font-medium text-gray-800>Minimum Followers</label>
                ...
                {/**Niche Filter */}
                <div>
                    <button onClick={() => toggleSection("niche")} className='flex 
            items-center justify-between w-full mb-3'>
                        <label text-sm font-medium text-gray-800>Niche</label>
                ...
                {/**Verification Status */}
                <div>
                    <button onClick={() => toggleSection("status")} className='flex 
            items-center justify-between w-full mb-3'>
                        <label text-sm font-medium text-gray-800>Status</label>
