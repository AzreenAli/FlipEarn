...
const Messages = () => {
  ...
  return (
    ...
    <div className='relative max-w-xl mb-8'>
      ...
      <input type="text" placeholder='Search conversations...' value=
    ...
    {loading ? (
      ...
      <div className='bg-white rounded-lg shadow-xs border border-gray-200 p-16 text-center'>
        ...
        <h3 className='text-xl font-medium text-gray-800 mb-2'>{searchQuery ? 
        'No chats found' : 'No messages yet'}</h3>
