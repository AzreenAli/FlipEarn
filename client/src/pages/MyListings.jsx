import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Edit, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, StarIcon, TrashIcon, TrendingUp, Users, Wallet, XCircle } from 'lucide-react';
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
      ...
      <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8'>
          ...
          <button onClick={()=>navigate('/create-listing')} className='bg-indigo-600 hover:bg-indigo-700 text-white px-6
          py-2 rounded font-medium flex items-center space-x-2 mt-4 md:mt-0'>
      ...
      border border-gray-200'>
        {[
          ...
          { label: 'Earned', value: balance?.earned ?? 0, icon: Wallet },
          ...
          <div onClick={()=> item.label === "Available" && setShowWithdrawal(true)} key={index} 
      ...
      (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {userListings.map((listing)=>(
            <div key={listing.id} className='bg-white rounded-lg border border-gray-200 hover:shadow-lg
                              ...
                              right-0 top-0 pt-4.5 z-10'>
                                ...
                                rounded border border-gray-200 p-2 px-3'>
                                  {!listing.isCredentialSubmitted && (
                                    <>
                                    <button onClick={()=> setShowCredentialSubmission(listing)} className='flex items-center gap-2
    ...
    <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
        <p className='text-sm text-gray-500'>
          © 2026 <span className='text-indigo-600'>Waffle</span>. All rights reserved.
        </p>
    </div>
      </div>
  )
